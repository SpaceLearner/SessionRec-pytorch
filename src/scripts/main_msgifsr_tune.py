...
wandb.init(project="wsdm22", entity="gjyspliter")
...
from src.utils.train_tune import TrainRunner
...
model = MSGIFSR(num_items, args.dataset_dir, args.embedding_dim, args.num_layers, dropout=args.feat_drop, reducer=args.reducer, order=args.order, norm=args.norm, extra=True, fusion=True, device=device)
