...
if opt.dataset == 'diginetica':
    ...
    pickle.dump(tes, open('yoochoose1_4/test_pre.txt', 'wb'))
    pickle.dump(tes, open('yoochoose1_64/test_pre.txt', 'wb'))
    ...
    pickle.dump(tra4, open('yoochoose1_4/train_pre.txt', 'wb'))
    pickle.dump(seq4, open('yoochoose1_4/all_train_seq.txt', 'wb'))

    pickle.dump(tra64, open('yoochoose1_64/train_pre.txt', 'wb'))
